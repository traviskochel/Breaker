...
class DeploymentsControllerTest < ActionController::TestCase
  ...
  test "should create deployment" do
    assert_difference('Deployment.count') do
      post :create, deployment: { name: @deployment.name, project_id: @deployment.project_id, user_id: @deployment.user_id }
    end
  ...
  test "should update deployment" do
    patch :update, id: @deployment, deployment: { name: @deployment.name, project_id: @deployment.project_id, user_id: @deployment.user_id }
    assert_redirected_to deployment_path(assigns(:deployment))
  end
